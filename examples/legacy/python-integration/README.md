...
`examples/legacy/cpp-integration` as a Python extension module generated with PyO3.
...
Rust `model!` / `entity!` / `fsm!` definitions in `examples/legacy/readme`; the bridge
