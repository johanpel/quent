    ...
    let model = if namespace.path().is_empty() {
        ...
        quote! {
            ...
            impl #runtime::Model for #model {
                ...
                fn model_info() -> #runtime::build_info::ModelInfo {
                    #runtime::build_info::ModelInfo {
                        name: #model_name.to_string(),
                        package: env!("CARGO_PKG_NAME").to_string(),
                        type_path: ::core::any::type_name::<
                            <Self as #runtime::Model>::Event,
                        >().to_string(),
                        source: #runtime::build_info::source_or_quent(
