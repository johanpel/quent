...
<section class="check-yourself" data-lesson="09">
  ...
  <fieldset data-answer="c" data-explanation="resource: true declares a unit resource that is claimed as one indivisible instance.">
    ...
    <label><input type="radio" name="q09a" value="a"> It has unlimited capacity</label>
    <label><input type="radio" name="q09a" value="b"> It emits repeated events</label>
    <label><input type="radio" name="q09a" value="c"> It is an indivisible resource</label>
  ...
  <fieldset data-answer="a" data-explanation="Thread scopes to ThreadPool, and Task scopes to the Thread reference carrying ThreadUsage.">
    ...
    <label><input type="radio" name="q09b" value="a"> <code>ThreadPool → Thread → Task</code></label>
    <label><input type="radio" name="q09b" value="b"> <code>Task → ThreadPool → Thread</code></label>
    <label><input type="radio" name="q09b" value="c"> No hierarchy</label>
    <p class="question-feedback"></p>
  </fieldset>
