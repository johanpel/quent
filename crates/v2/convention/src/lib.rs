...
pub trait Convention {
    ...
    /// human-readable dot-separated pattern <project>.<convention>.<version>.
    /// For example: "quent.fsm.v1". This reduces the probability of name
    /// clashes with dependencies, and provides a means of easily detecting
    /// breaking changes to the convention's own schema.
